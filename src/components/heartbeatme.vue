<template>
	...
	<div class="figure" v-show="!bol">
		...
		<div class="figureitem" v-for='(item,index) in listData' :key='item.id' @click="goPersonage(item.status,item.be_member_id,item.id)" v-show="ascny1" v-cloak>
			<div class="figureone">
	...
	<div class="figure" v-show="bol">
		...
		<div class="figureitem" v-for='(item,index) in listData' :key='item.id' @click="goOption(item.status,item.member_id,item.id)" v-show="ascny1" v-cloak>
			<div class="figureone">
			...
			<div class="figurethree" style="flex: 1;margin-top: 1.7rem;margin-right: 0.5rem;display: flex;justify-content: space-between;margin-left: 0.5rem;">
...
<style>
	...
	#heartbeatme .mark_content>ul {
		padding: 1rem;
	}
	
	#heartbeatme .mark_content>ul>li {
		display: flex;
		line-height: 2.5rem;
	}
	#heartbeatme .dele {
