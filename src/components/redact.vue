<template>
  <div id='redact' v-cloak>
    <div class="section">
      <div class="baseitem">
        <dl style="width: 5rem;height: 5rem;">
          <img src="../../static/img/18.png" alt="图片加载有误" v-if='img==""'
               style='border-radius: 50%;width: 100%;max-width: 100%;height: 100%;'/>
        ...
        <p>
          <label for="">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄：</label>
          <input type="text" max="2" placeholder="请输入年龄" v-model="personal.age" @input="okkkk">
        </p>
        <p>
          <label for="">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label>
        ...
        <div class="load" v-show="show">
          <p>请上传身份证正反面</p>
          <!--<el-upload name='album' :headers="header" action="http://yinhan-media.weiyingjia.org/api/yinhan/memberimg" type='1' list-type="picture-card" :file-list="imgList" multiple :limit="3" :on-exceed="handleExceed" :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :on-error='handleError' accept="image/*">
                        <i class="el-icon-plus"></i>
                    </el-upload>-->
          <el-upload name='album' action='string' list-type="picture-card" :file-list="imgList" :headers="header"
                     :on-preview="handlePictureCardPreview" :on-success='handleSuccess' :on-remove.self="handleRemove"
                     multiple :limit="2" :on-exceed="handleExceed" :http-request='upload' :on-error='handleError'
                     accept="image/*" ref='upload'>
            <i class="el-icon-plus"></i>
          </el-upload>
        </div>
        <div class="load" v-show="show1">
          <p>请上传离婚证明和身份证正反面</p>
          <!--<el-upload name='album' :headers="header" action="http://yinhan-media.weiyingjia.org/api/yinhan/memberimg" type='2' list-type="picture-card" :file-list="imgList" :on-preview="handlePictureCardPreview" multiple :limit="3" :on-exceed="handleExceed" :on-remove="handleRemove" :on-error='handleError' accept="image/*">
                        <i class="el-icon-plus"></i>
                    </el-upload>-->
          <el-upload name='album' action='string' list-type="picture-card" :file-list="imgList" :headers="header"
                     :on-preview="handlePictureCardPreview" :on-success='handleSuccess' :on-remove.self="handleRemove"
                     multiple :limit="3" :on-exceed="handleExceedd" :http-request='upload' :on-error='handleError'
                     accept="image/*" ref='upload'>
            <i class="el-icon-plus"></i>
          </el-upload>
        </div>
        <div class="newimg load" v-show="show2">
          <p>请上传死亡证明和身份证正反面</p>
          <!--<el-upload name='album' :headers="header" action="http://yinhan-media.weiyingjia.org/api/yinhan/memberimg" :file-list="imgList" type='3' list-type="picture-card" :on-preview="handlePictureCardPreview" multiple :limit="3" :on-exceed="handleExceed" :on-remove="handleRemove" :on-error='handleError' accept="image/*">
                        <i class="el-icon-plus"></i>
                    </el-upload>-->
          <el-upload name='album' action='string' list-type="picture-card" :file-list="imgList" :headers="header"
                     :on-preview="handlePictureCardPreview" :on-success='handleSuccess' :on-remove.self="handleRemove"
                     multiple :limit="3" :on-exceed="handleExceeddd" :http-request='upload' :on-error='handleError'
                     accept="image/*" ref='upload'>
            <i class="el-icon-plus"></i>
          </el-upload>
        </div>
        <p class='mySelect'>
          ...
          <x-address title="" v-model="personal.location" raw-value :list="addressData" value-text-align="left"
                     label-align="justify" placeholder="请选择您的户籍所在地"></x-address>
          <!--<span class='moreAge'>
        ...
        <p>
          ...
          <popup-picker title="" placeholder="请选择您的月收入" :data="myIncome" v-model="personal.income"
        ...
        <p class='mySelect'>
          ...
          <x-address title="" v-model="personal.familyLocal" raw-value :list="addressData" value-text-align="left"
                     label-align="justify" placeholder="请选择您的家庭住址"></x-address>
          <!--<span class='moreAge'>
                            <i class="el-icon-arrow-right"></i>
                    </span>-->
        </p>
      ...
      <div class='required baseitem'>
        ...
        <p class='mySelect'>
          ...
          <popup-picker title="" placeholder="请选择您希望她/他的年龄段" :data="selectData" v-model="selection.agePart"
                        value-text-align="left"></popup-picker>
        </p>
        <p class='mySelect'>
          <label for="">居&nbsp;&nbsp;住&nbsp;&nbsp;地：</label>
          <x-address title="" hide-district v-model="selection.address" raw-value :list="addressData"
                     value-text-align="left" label-align="justify" placeholder="请选择您希望她/他的居住地"></x-address>
          <!--<span class='moreAge'>
                            <i class="el-icon-arrow-right"></i>
                        </span>-->
        </p>
        <p class='mySelect'>
          <label for="">身&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;高：</label>
          <popup-picker title="" placeholder="请选择您希望她/他的身高（cm）" :data="heightData" v-model="selection.height"
                        value-text-align="left"></popup-picker>
        </p>
        <p>
          <label for="">体&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重：</label>
          <popup-picker title="" placeholder="请选择您希望她/他的体重（kg）" :data="weightData" v-model="selection.weight"
                        value-text-align="left"></popup-picker>
        </p>
        <p class='mySelect'>
          <label for="" style="margin-left: -0.9rem;width: 8.5rem;">户籍所在地：</label>
          <x-address title="" hide-district v-model="selection.local" raw-value :list="addressData"
                     value-text-align="left" label-align="justify" placeholder="请选择您希望她/他的户籍所在地"></x-address>
        </p>
        <p>
          <label for="">民&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;族：</label>
        ...
        <p class='mySelect'>
          <label for="">月&nbsp;&nbsp;收&nbsp;&nbsp;入：</label>
          <popup-picker title="" placeholder="请选择您希望她/他的月收入" :data="incomeData" v-model="selection.income"
                        value-text-align="left"></popup-picker>
        </p>
        <p>
          <label for="">文化程度：</label>
  ...
  export default {
    ...
    data() {
      return {
        ...
        weightData: [
          ["不限", "60~70kg", "70~80kg", "80~90kg", "90kg以上"]
        ],
        incomeData: [
    ...
    methods: {
      ...
      getMsg() {
        ...
        this.$http({
          ...
          console.log(res)
          Indicator.close();
          _this.getMsgdata = res.data.data;
          console.log(_this.getMsgdata.con.marital)

          this.names = res.data.data.wechat.nickname;
          this.img = res.data.data.wechat.headimgurl;
          //个人信息
          _this.personal.name = _this.getMsgdata.in.true_name;
          _this.personal.age = _this.getMsgdata.in.age;
          _this.personal.sex = _this.getMsgdata.in.sex;
          _this.personal.height = _this.getMsgdata.in.height;
          _this.personal.weight = _this.getMsgdata.in.weight;
          _this.personal.postion = _this.getMsgdata.in.worker;
          //					_this.personal.income = _this.getMsgdata.in.income;
          _this.personal.income.push(_this.getMsgdata.in.income)
          _this.personal.education = _this.getMsgdata.in.education;
          _this.personal.familyLocal = JSON.parse(_this.getMsgdata.in.address);
          _this.personal.number = _this.getMsgdata.in.tel;
          _this.personal.IDcard = _this.getMsgdata.in.idcard;
          _this.personal.hobby = _this.getMsgdata.in.hobby;
          _this.personal.status = _this.getMsgdata.in.marital;
          _this.personal.location = JSON.parse(_this.getMsgdata.in.household_register_address);
          _this.personal.national = _this.getMsgdata.in.nation;
          _this.personal.children = _this.getMsgdata.in.children_status;
          _this.personal.housing = _this.getMsgdata.in.house_status;
          //择偶标准
          _this.selection.address = JSON.parse(_this.getMsgdata.con.address);
          _this.selection.children = _this.getMsgdata.con.children_status;
          _this.selection.local = JSON.parse(_this.getMsgdata.con.household_register_address);
          _this.selection.hobby = _this.getMsgdata.con.hobby;
          _this.selection.nation = _this.getMsgdata.con.nation;
          _this.selection.housing = _this.getMsgdata.con.house_status;
          _this.selection.education = _this.getMsgdata.con.education;
          _this.selection.status = JSON.parse(_this.getMsgdata.con.marital);
          _this.selection.income.push(_this.getMsgdata.con.income)
          _this.selection.weight.push(_this.getMsgdata.con.weight)
          _this.selection.height.push(_this.getMsgdata.con.height)
          _this.selection.agePart.push(_this.getMsgdata.con.age)
          //					_this.selection.income = JSON.parse(_this.getMsgdata.con.income)
          //					_this.selection.weight = JSON.parse(_this.getMsgdata.con.weight)
          //					_this.selection.height = JSON.parse(_this.getMsgdata.con.height)
          //					_this.selection.agePart = JSON.parse(_this.getMsgdata.con.age)
          //					_this.selection.agePart=JSON.parse(_this.getMsgdata.con.age)
          //					_this.selection.height=JSON.parse(_this.getMsgdata.con.height)
          //					_this.selection.weight=JSON.parse(_this.getMsgdata.con.weight)
          //					_this.selection.income=JSON.parse(_this.getMsgdata.con.income)
          //					_this.selection.height = (_this.getMsgdata.con.height).toString()
          //					_this.selection.weight = (_this.getMsgdata.con.weight).toString()
          //					_this.selection.income = (_this.getMsgdata.con.income).toString()
        ...
        this.$http({
          method: "get",
          url: "http://yinhan-media.weiyingjia.org/api/yinhan/memberimgs",
          params: {},
          headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer " + this.tokenNew
...
<style scoped>
  ...
  #redact .baseitem dl dt img {
    width: 100%;
    height: auto;
  }

  #redact .baseitem dl dd {
    margin-left: 1rem;
    margin-top: 2rem;
  }

  #redact .baseitem p label {
    display: inline-block;
    /*width: 8rem;*/
  }

  #redact .baseitem p input {
    flex: 1;
    border: none;
    outline: none;
    padding-left: 0.5rem;
  ...
  #redact .baseitem p input::-webkit-input-placeholder {
    color: #cccccc;
    font-size: 1rem;
  }

  #redact .el-radio__input.is-checked .el-radio__inner {
    border-color: #b674fd;
    background: #b674fd;
  }
  ...
  #redact .mark_content > ul {
    padding: 1rem;
    text-align: center;
    padding-bottom: 6rem;
  }

  #redact .mark_content > ul > li {
    display: flex;
    line-height: 2.5rem;
  ...
  #redact .mark_content > ul > li > span {
    flex: 25%;
    text-align: center;
    font-size: 1.2rem;
  }

  #redact .mark_content > ul > li > span:hover {
    color: #b674fd;
  }
...
<style>
  ...
  #redact .el-radio__input.is-checked + .el-radio__label {
    color: #b674fd;
  }

  #redact .el-radio__inner {
    border-radius: 20%;
  }

  #redact .el-radio + .el-radio {
    margin: 4px;
  }

  #redact .el-radio__label {
    padding-left: 7px;
  }
  ...
  #redact .el-upload-list--picture-card .el-upload-list__item {
    width: 4.43rem;
    height: 4.43rem;
    background: #eeeeee;
    border-radius: 3px;
  ...
  #redact .el-icon-zoom-in:before {
    content: "";
  }

  #redact .el-upload-list__item-delete {
    margin-left: 0;
  }

  #redact .mySelect label {
  ...
  #redact .vux-cell-box:before {
    border-top: none;
  }

  #redact .vux-popup-picker-placeholder {
    opacity: 0.6;
    height: 2rem;
    line-height: 2rem;
  }

  #redact .el-checkbox__input.is-checked .el-checkbox__inner {
    background: #B674FD;
    border-color: #B674FD;
  }

  #redact .el-checkbox__input.is-checked + .el-checkbox__label {
    color: #B674FD;
  }

  #redact .vux-popup-picker-select {
    width: 100%;
  }
</style>
