...
<style>
	...
	#personageThree .banner {
		width: 100%;
		height: 14rem;
		padding-bottom: 4rem;
	}
	
	#personageThree .banner>img {
		width: 100%;
		max-width: 100%;
		height: 100%;
	}
	
	#personageThree .mark_content p {
		width: 100%;
		line-height: 2.5rem;
		text-align: center;
	}
	...
	#personageThree .mainname {
		width: 95%;
		margin: 0 auto;
	}
	
	#personageThree .mainnametop {
	...
	#personageThree .mainnametop li:first-child {
		font-size: 1.2rem;
		color: #666666;
		letter-spacing: 0;
	}
	
	#personageThree .mainnametop li:first-child span {
		color: #151515;
	}
	
	#personageThree .mainnametop li:last-child {
		font-size: 1rem;
		color: #b674fd;
		margin-top: 0.35rem;
	}
	
	#personageThree .mainnamebottom {
		margin-top: 0.5rem;
		display: flex;
	}
	
	#personageThree .mainnamebottom li {
		font-size: 1.08rem;
		color: #666666;
		letter-spacing: 0;
		line-height: 2.5;
	...
	#personageThree .mainnamebottom li span {
		color: #151515;
	}
	
	#personageThree .mainnameright {
		margin-left: 2.8rem;
	}
	
	#personageThree .speciality li {
		line-height: 2.5;
		font-size: 1.08rem;
		color: #666666;
		letter-spacing: 0;
	...
	#personageThree .speciality li span {
		color: #151515;
	}
	
	#personageThree .mainfoot {
		margin-top: 0.8rem;
		width: 100%;
		box-shadow: 0 2px 9px 0 #eeeeee;
		border-radius: 3px;
	...
	#personageThree .mainfootboxright {
		margin-right: 3rem;
	}
	
	#personageThree .mainfootbox {
		width: 95%;
		margin: 0 auto;
	}
	...
	#personageThree .bottom {
		display: flex;
		justify-content: space-between;
	}
	
	#personageThree .bottom li {
		line-height: 2.5;
		font-size: 1.08rem;
		color: #666666;
		letter-spacing: 0;
	...
	#personageThree .mark_content>h2 {
		position: relative;
		text-align: left;
		line-height: 4rem;
		font-size: 1.7rem;
	...
	#personageThree .el-message-box--center {
		width: 80%;
		position: absolute;
		top: 40%;
		/* left: 10%; */
	...
	#personageThree .footer button {
		/* padding: 0.8rem 0;
		width: 10.7rem; */
		width: 35%;
		font-size: 0.9rem;
	}
	/*#personageThree .footer button:first-child {
		background: #ffffff;
		border: 1px solid #b674fd;
