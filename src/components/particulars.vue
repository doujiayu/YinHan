<template>
	<div id="particulars">
		...
		<div class="footer">
			<el-button type="text" @click="tishi">邀约中</el-button>
		</div>
	</div>
</template>
...
<style>
	...
	#particulars .banner>img {
		width: 100%;
		max-width: 100%;
		height: 100%;
	}
	
	#particulars .mark_content p {
		width: 100%;
		line-height: 2.5rem;
		text-align: center;
	}
	...
	#particulars .mainname {
		width: 95%;
		margin: 0 auto;
	}
	
	#particulars .mainnametop {
	...
	#particulars .mainnametop li:first-child {
		font-size: 1.2rem;
		color: #666666;
		letter-spacing: 0;
	}
	
	#particulars .mainnametop li:first-child span {
		color: #151515;
	}
	
	#particulars .mainnametop li:last-child {
		font-size: 1rem;
		color: #b674fd;
		margin-top: 0.35rem;
	}
	
	#particulars .mainnamebottom {
		margin-top: 0.5rem;
		display: flex;
	}
	
	#particulars .mainnamebottom li {
		font-size: 1.08rem;
		color: #666666;
		letter-spacing: 0;
		line-height: 2.5;
	...
	#particulars .mainnamebottom li span {
		color: #151515;
	}
	
	#particulars .mainnameright {
		margin-left: 2.8rem;
	}
	
	#particulars .speciality li {
		line-height: 2.5;
		font-size: 1.08rem;
		color: #666666;
		letter-spacing: 0;
	...
	#particulars .speciality li span {
		color: #151515;
	}
	
	#particulars .mainfoot {
		margin-top: 0.8rem;
		width: 100%;
		box-shadow: 0 2px 9px 0 #eeeeee;
		border-radius: 3px;
	...
	#particulars .mainfootboxright {
		margin-right: 3rem;
	}
	
	#particulars .mainfootbox {
		width: 95%;
		margin: 0 auto;
	}
	...
	#particulars .el-message-box--center {
		width: 80%;
		position: absolute;
		top: 40%;
		/* left: 10%; */
	...
	#particulars .footer button {
		/* padding: 0.8rem 0;
		width: 10.7rem; */
		width: 35%;
		font-size: 0.9rem;
	}
	/*#particulars .footer button:first-child {
		background: #ffffff;
		border: 1px solid #b674fd;
